...
describe("TshirtsComponentSpectator", () => {
  ...
  beforeEach(() => {
    ...
    spectator.inject<TshirtsService>(TshirtsService).get.and.returnValue(
      of([
        {
  ...
  describe("buy item", () => {
    it("should buy second item when clicked event emited", () => {
      ...
      const cartService: CartService &
        SpyObject<CartService> = spectator.inject<CartService>(CartService);

      // act
      const items: TshirtItemComponent[] = spectator.queryAll<
        TshirtItemComponent
      >(TshirtItemComponent);
    ...
    it("should show toast on success", () => {
      ...
      const toastrService: ToastrService &
        SpyObject<ToastrService> = spectator.inject<ToastrService>(
        ToastrService
      );
